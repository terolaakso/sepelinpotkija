  ...
  return {
    ...
    timeTableRows: [
      ...
      timetableRowFixture({
        ...
        trainStopping: false,
        scheduledTime: '2022-07-15T06:59:38.000Z',
        actualTime: '2022-07-15T06:59:38.000Z',
      }),
      timetableRowFixture({
        stationShortCode: 'KLO',
        trainStopping: false,
      ...
      timetableRowFixture({
        ...
        trainStopping: true,
        commercialStop: true,
        scheduledTime: '2022-07-15T07:14:58.000Z',
        actualTime: '2022-07-15T07:14:58.000Z',
      }),
    ],
    ...props,
  };
...
const defaultTimetableRow: TimeTableRow = {
  ...
  commercialTrack: '5',
  cancelled: false,
  scheduledTime: '2022-07-15T06:40:00.000Z',
  actualTime: '2022-07-15T06:40:00.000Z',
